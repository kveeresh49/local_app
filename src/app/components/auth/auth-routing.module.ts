...
const routes: Routes = [
  ...
  { path: 'login', component: LoginComponent, canActivate: [AuthGuard],  data: {isAuthComonent: true}   },
  {
    path: 'create-account',
  ...
  { path: 'otp', component: LoginOtpComponent, canActivate: [AuthGuard],  data: {isAuthComonent: true}  },
  {
    path: 'forgotpassword',
